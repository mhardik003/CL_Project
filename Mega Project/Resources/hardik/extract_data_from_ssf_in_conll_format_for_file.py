...
if __name__ == '__main__':
    ...
    parser.add_argument('--/home/sankalp/Programs/SEM_2/CL_Project/team_1/input.dat', dest='inp',
                        help="Add the input file path")
    parser.add_argument('--/home/sankalp/Programs/SEM_2/CL_Project/SSF-API-master/result.dat', dest='out',
                        help="Add the output file path")
    parser.add_argument('--3', dest='level',
